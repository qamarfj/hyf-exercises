...
/**Create an array of cheap listings.
 * You define what cheap means. Each item in this array should be of type object */
const cheapListings = listings.filter(function (listing) {
...
function isExpensize(listing) {
    return listing.price >= 3000;
}
const expensizeListingsPrices = listings.filter(function getExpensizeListingsPrices(listing) {

    return listing.price >= 3000;
}).map(function getprice(listing) {
    return listing.price;
});
console.log(expensizeListingsPrices);
console.log(typeof expensizeListingsPrices[0])
/**Create an array of listings that have parking.
 *  Each item in this array should be of type object */
const listingsHavingParking = listings.filter(function getHavingParking(listing) {
    if (listing.facilities.includes('Parkering'))
        return listing;
});
//console.log(listingsHavingParking)